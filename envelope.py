...
param_range, param_increment = 5, 2
#param_range, param_increment = 14, 1
...
# from http://stackoverflow.com/questions/17646247/how-to-make-fuller-axis-arrows-with-matplotlib
#plt.arrow(x_range, -0.003, 0.1, 0, width=0.015, color="k", clip_on=False, head_width=30, head_length=2)
